...
def main():
    ...
    with tab1:
        ...
        st.markdown("### 🚀 Cómo funciona el Pipeline de Análisis")
        st.markdown("""
        El sistema opera en **3 fases secuenciales** para maximizar la detección de oportunidades:
        
        1. **Fase de Crawling:** Se navegan las URLs del centro, se normalizan (limpiando tracking) y se extrae el texto limpio + enlaces internos relevantes.
        2. **Fase de Extracción con IA:** El contenido se procesa mediante modelos de lenguaje especializados para identificar **Tecnologías**, **Artículos**, **Empresas** y **Personas**, asignando un score de relevancia.
        3. **Fase de Enriquecimiento:** Se cruzan datos con **ORCID** para validar investigadores y se almacena todo en caché para evitar reprocesamiento.
        """)

...
Analiza los documentos proporcionados y genera un análisis estructurado en formato JSON:

{
  "summary": "Resumen ejecutivo del contenido analizado (2-3 líneas)",
  "key_points": [
    "Punto clave 1 identificado en los documentos",
    "Punto clave 2 identificado en los documentos",
    "Punto clave 3 identificado en los documentos"
  ],
  "recommended_actions": [
...
Sé preciso y basa tu análisis únicamente en el contenido de los documentos.""",
        height=220,
        key="openai_system"
    )
            ...
            try:
                ...
                response = st.session_state.openai.chat.completions.create(
                    ...
                    messages=[
                        ...
                        {"role": "user", "content": f"""DOCUMENTOS A ANALIZAR:
{context}
